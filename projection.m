function [projImage, left_edge, left_delta, upper_edge, upper_delta] = projection(image,homography_mat)
...
max_col_projimg = max(upper_right(1), bottom_right(1));
min_row_projimg = min(upper_left(2), upper_right(2));
max_row_projimg = max(bottom_left(2), bottom_right(2));
